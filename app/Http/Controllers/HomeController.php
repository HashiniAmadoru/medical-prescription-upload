...
class HomeController extends Controller
{
    ...
    public function viewQuatation($id)
    {
        ...
        $viewpresData = DB::select("SELECT * FROM `prescription`  
            ...
            INNER JOIN  `drugs` ON prescriptiondrugs.drug_id = drugs.id 
    ...
    public function acceptQuatation($id)
    {
        ...
        $a = DB::select("SELECT prescription.*, users.id FROM `prescription`  
        ...
        $a = DB::select("SELECT prescription.*, users.name,users.email FROM `prescription`  
            INNER JOIN  `users` ON prescription.user_id = users.id 
            WHERE prescription.id = $id");
        ...
        $data['subject'] = 'Quatation Details Accepted';

        $data['title'] = 'Quatation';

        $data['msg'] = 'Your Quatation was Accepted.';

        $mail = addPrescription::sendEmail($data);
    ...
    public function rejectQuatation($id)
    {
        ...
        $data['subject'] = 'Quatation Details Rejected';

        $data['title'] = 'Quatation';

        $data['msg'] = 'Your Quatation was Rejected.';
    ...
    public function adminquatationForm($id)
    {
        ...
        $allPresDetails = DB::select("SELECT * FROM `prescriptiondrugs`  
            INNER JOIN  `drugs` ON prescriptiondrugs.drug_id  = drugs.id WHERE prescriptiondrugs.prescription_id = $id");
    ...
    public function sendQuatation($id)
    {
        ...
        $data['subject'] = 'Quatation Details - Hirusha Pharmarcy';

        $data['title'] = 'Quatation';

        $data['msg'] = 'Your Quatation was ready.';
